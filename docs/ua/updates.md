# Оновлення та обслуговування системи (v1.0.5)

OpenTrace v1.0.5 вводить систему автоматичних оновлень, яка дозволяє підтримувати вашу інсталяцію в актуальному стані одним кліком в панелі адміністратора.
