export const translations = {
    en: {
        ...
        hero: {
            ...
            subtitle: "A powerful, open-source alternative to Google Analytics. Track everything without compromising user privacy.",
            ctaPrimary: "Get Started",
            ctaSecondary: "View on GitHub",
            help: {
                title: "Welcome to OpenTrace",
                content: "OpenTrace is a next-generation analytics platform. You can use it to track websites, mobile apps, and Telegram bots. All data is processed in real-time and stays on your infrastructure."
            }
        },
        dashboard: {
        ...
        campaigns: {
            ...
            help: {
                ...
                content: "Create tracked links for your ads. Use the UTM generator for websites or deep-link generator for Telegram bots to identify exactly which ad source brought the user."
            },
            table: {
                source: "Source",
                medium: "Medium",
        ...
        tags: {
            ...
            help: {
                ...
                content: "Manage third-party analytics (FB Pixel, GA4) in one place. Add the OpenTrace container to your site once, and toggle other scripts on/off without touching your code."
            },
            table: {
                name: "Tag Name",
                provider: "Provider",
        ...
        settings: {
            ...
            help: {
                title: "Settings",
                content: "Configure your global system preferences and security tokens here."
            },
        ...
        custom: {
            ...
            help: {
                ...
                content: "Design your own visualization widgets. Connect directly to raw data streams and build custom KPIs."
            }
        },
        auth: {
        ...
        features_block: {
            ...
            trackingDesc: "Track interactions across any platform - websites, mobile apps, or custom APIs.",
            realtime: "Real-time Processing",
            realtimeDesc: "Built on ClickHouse for instant insights without sampling or delays.",
            ownership: "Data Sovereignty",
            ownershipDesc: "Your data stays on your infrastructure. You own 100% of your telemetry."
        },
        footer: {
        ...
        landing: {
            ...
            hero: {
                ...
                title: "Own Your Analytics Data",
                subtitle: "A powerful, open-source alternative to Google Analytics. Track everything without compromising user privacy. Deploy on your infrastructure in minutes.",
            ...
            features: {
                ...
                subtitle: "Powerful analytics platform with enterprise features, built for privacy and performance.",
                analytics: {
    ...
    ua: {
        ...
        hero: {
            ...
            subtitle: "Потужна альтернатива Google Analytics з відкритим кодом. Відстежуйте все без компромісів.",
            ctaPrimary: "Почати",
            ctaSecondary: "GitHub",
            help: {
                title: "Ласкаво просимо в OpenTrace",
                content: "OpenTrace — це аналітична платформа нового покоління. Ви можете використовувати її для відстеження сайтів, мобільних додатків та Telegram-ботів. Всі дані обробляються в реальному часі та залишаються на вашій інфраструктурі."
            }
        },
        dashboard: {
        ...
        campaigns: {
            ...
            help: {
                ...
                content: "Створюйте відстежувані посилання для вашої реклами. Використовуйте UTM-генератор для сайтів або deep-link генератор для ботів, щоб точно знати, яке джерело привело користувача."
            },
            table: {
                source: "Джерело",
                medium: "Канал",
        ...
        tags: {
            ...
            help: {
                ...
                content: "Керуйте сторонньою аналітикою (FB Pixel, GA4) в одному місці. Додайте контейнер OpenTrace на сайт один раз, і вмикайте/вимикайте інші скрипти без редагування коду."
            },
            table: {
                name: "Назва тегу",
                provider: "Провайдер",
        ...
        settings: {
            ...
            help: {
                ...
                content: "Налаштовуйте свій робочий простір, керуйте ключами доступу API для розробників та змінюйте мову інтерфейсу."
            },
        ...
        analytics: {
            ...
            help: {
                title: "Аналітика",
                content: "Використовуйте цей розділ для сегментації трафіку. Фільтри дозволяють фокусуватися на конкретних джерелах, девайсах або періодах."
            },
            metrics: {
        ...
        custom: {
            ...
            help: {
                ...
                content: "Проектуйте власні віджети візуалізації. Підключайтеся до сирих даних та створюйте власні KPI."
            }
        },
        auth: {
            ...
            help: {
                title: "Доступ до системи",
                content: "Використовуйте свої облікові дані адміністратора для доступу до панелі керування. Дефолтні дані: admin@opentrace.io / admin."
            }
        },
        features_block: {
            tracking: "Універсальний трекінг",
            trackingDesc: "Відстежуйте взаємодії на будь-якій платформі — сайтах, додатках або API.",
            realtime: "Миттєва обробка",
            realtimeDesc: "Побудовано на ClickHouse для швидких інсайтів без затримок.",
            ownership: "Власні дані",
            ownershipDesc: "Ваші дані залишаються на вашій інфраструктурі. Ви володієте ними на 100%."
        },
        footer: {
            copyright: "© 2025 OpenTrace Analytics",
        },
        landing: {
            ...
            hero: {
                ...
                subtitle: "Потужна альтернатива Google Analytics з відкритим кодом. Відстежуйте все без компромісів для приватності. Розгорніть на своїй інфраструктурі за хвилини.",
            ...
            features: {
                ...
                subtitle: "Потужна аналітична платформа з корпоративними функціями, створена для приватності та продуктивності.",
                analytics: {
    ...
    pl: {
        ...
        hero: {
            ...
            subtitle: "Potężna alternatywa dla Google Analytics z otwartym kodem źródłowym. Śledź wszystko bez narażania prywatności.",
            ctaPrimary: "Rozpocznij",
            ctaSecondary: "Zobacz na GitHub",
            help: {
                title: "Witamy w OpenTrace",
                content: "OpenTrace to platforma analityczna nowej generacji. Możesz jej używać do śledzenia stron, aplikacji mobilnych i botów Telegram. Wszystkie dane są przetwarzane w czasie rzeczywistym i pozostają na Twojej infrastrukturze."
            }
        },
        dashboard: {
            ...
            help: {
                title: "O Panelu",
                content: "Panel zapewnia ogólny widok całej infrastruktury. Tutaj możesz śledzić ruch w czasie rzeczywistym, współczynniki konwersji i stan podłączonych zasobów."
            }
        },
        resources: {
            title: "Twoje zasoby",
            ...
            help: {
                ...
                content: "Zasoby są rdzeniem Twojego śledzenia. Dodaj tutaj swoje strony lub boty Telegram, aby otrzymać unikalny identyfikator śledzenia (Tracking ID)."
            },
            table: {
                name: "Nazwa zasobu",
                type: "Typ",
        ...
        campaigns: {
            ...
            help: {
                ...
                content: "Twórz śledzone linki dla swoich reklam. Używaj generatora UTM dla stron lub generatora deep-linków dla botów Telegram."
            },
            table: {
                source: "Źródło",
                medium: "Medium",
        ...
        events: {
            ...
            help: {
                ...
                content: "Skonfiguruj, jakie akcje śledzić. Możesz zdefiniować kliknięcia przycisków lub wizyty na stronie jako kluczowe zdarzenia."
            },
            table: {
        ...
        tags: {
            ...
            help: {
                ...
                content: "Zarządzaj analityką zewnętrzną (FB Pixel, GA4) w jednym miejscu."
            },
            table: {
                name: "Nazwa tagu",
                provider: "Dostawca",
        ...
        settings: {
            ...
            help: {
                title: "Ustawienia",
                content: "Skonfiguruj tutaj globalne preferencje systemu i tokeny bezpieczeństwa."
            },
        ...
        analytics: {
            ...
            help: {
                ...
                content: "Użyj tej sekcji, aby filtrować dane o ruchu. Filtry pozwalają skupić się na konkretnych źródłach, urządzeniach lub ramach czasowych."
            },
            metrics: {
                visitors: "Wizyty",
                views: "Odsłony",
        ...
        auth: {
            ...
            help: {
                title: "Dostęp",
                content: "Użyj poświadczeń administratora, aby uzyskać dostęp do bezpiecznego obszaru."
            }
        },
        features_block: {
            tracking: "Uniwersalne śledzenie",
            trackingDesc: "Śledź interakcje na dowolnej platformie — stronach, aplikacjach lub API.",
            ...
            ownershipDesc: "Twoje dane pozostają na Twojej infrastrukturze. Własność telemetryczna 100%."
        },
        footer: {
            copyright: "© 2025 OpenTrace Analytics",
        },
        landing: {
            ...
            hero: {
                ...
                subtitle: "Potężna alternatywa open-source dla Google Analytics. Śledź wszystko bez naruszania prywatności użytkowników. Wdróż na własnej infrastrukturze w kilka minut.",
            ...
            features: {
                ...
                subtitle: "Potężna platforma analityczna z funkcjami korporacyjnymi, zbudowana dla prywatności i wydajności.",
                analytics: {
    ...
    de: {
        ...
        hero: {
            ...
            subtitle: "Eine leistungsstarke Open-Source-Alternative zu Google Analytics. Tracken Sie alles, ohne die Privatsphäre zu verletzen.",
            ctaPrimary: "Loslegen",
            ctaSecondary: "Auf GitHub ansehen",
            help: {
                title: "Willkommen bei OpenTrace",
                content: "OpenTrace ist eine Analyseplattform der nächsten Generation. Sie können damit Websites, mobile Apps und Telegram-Bots tracken."
            }
        },
        dashboard: {
            ...
            help: {
                ...
                content: "Das Dashboard bietet einen Überblick über Ihre gesamte Infrastruktur."
            }
        },
        resources: {
        ...
        landing: {
            ...
            hero: {
                ...
                subtitle: "Eine leistungsstarke Open-Source-Alternative zu Google Analytics. Tracken Sie alles ohne Kompromisse beim Datenschutz. In Minuten auf Ihrer Infrastruktur bereitgestellt.",
            ...
            features: {
                ...
                subtitle: "Leistungsstarke Analyseplattform mit Enterprise-Funktionen, gebaut für Datenschutz und Leistung.",
                analytics: {
