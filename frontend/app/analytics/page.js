        ...
        <div className="fade-in">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '24px', marginBottom: '32px' }}>
                {[
                    ...
                    { key: 'views', label: t('analytics.metrics.views'), val: stats?.metrics?.views || 0, color: '#10b981' },
                    { key: 'bounce', label: t('dashboard.stats.bounce'), val: (stats?.metrics?.bounce_rate || 0) + '%', color: '#f43f5e' },
                ].map((m) => (
