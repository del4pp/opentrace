                                ...
                                <tr key={ev.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                                    ...
                                    <td style={{ padding: '20px 24px', textAlign: 'right' }}>
                                        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '16px' }}>
                                            <button
                                                onClick={() => openEdit(ev)}
                                                style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', color: 'var(--text)', opacity: 0.6, transition: '0.2s' }}
                                            ...
                                            <button
                                                ...
                                                style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', color: '#ef4444', opacity: 0.6, transition: '0.2s' }}
                                                onMouseEnter={e => e.currentTarget.style.opacity = 1}
                                                onMouseLeave={e => e.currentTarget.style.opacity = 0.6}
                                            >
